      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-dark-text">
            {isLogin ? 'Welcome Back Trekker' : 'Join the Expedition'}
          </h2>
          <p className="text-sm text-dark-muted mt-1">
            {isLogin ? 'Sign in to access your groups and gear.' : 'Create an account to start coordinates planning.'}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-xs font-bold uppercase tracking-wider text-dark-muted mb-2">Username</label>
            <div className="relative">
              ...
              <input 
                ...
                required
                className="w-full pl-11 pr-4 py-3 rounded-xl glass-input text-dark-text text-sm"
          ...
          {!isLogin && (
            <div>
              <label className="block text-xs font-bold uppercase tracking-wider text-dark-muted mb-2">Email Address</label>
              <div className="relative">
          ...
          <div>
            <label className="block text-xs font-bold uppercase tracking-wider text-dark-muted mb-2">Password</label>
            <div className="relative">
